  ...
  return (
    ...
    <header className="project-header">
        ...
        <div className="titlelogodaramic">
            <h1 className="project-title">Stage ServiceNow - Optimisation de la Gestion des Services IT chez Daramic</h1>
            <div> 
                <img src="/imagesProjet/logoServiceNow.jpg" alt="Logo ServiceNow" style={{ maxHeight: '200px' }} />
                <img src="/imagesProjet/logoDaramic.jpg" alt="Logo Daramic" style={{ maxHeight: '300px' }} />
            </div>
        </div>
    </header>
